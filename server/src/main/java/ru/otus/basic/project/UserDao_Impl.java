...
public class UserDao_Impl implements UserDao {
    ...
    public void insertFirstAdmin() throws SQLException {
        ...
        insert(admin);
        logger.info("First Admin User added");
    }
    ...
    public Optional<User> insert(User user) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(
            ...
            try (ResultSet generatedKeys = statement.getGeneratedKeys()) {
                ...
                logger.warn("Failed to get ID. User {}", user.getName());
                return Optional.empty();
            }
        } catch (SQLException e) {
            logger.error("Failed to insert user {}. {}", user.getName(), e.getMessage());
            return Optional.empty();
        }
    }
    ...
    public boolean findByNickname(String nickname) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            logger.error("Failed to find user by nickname {}. {}", nickname, e.getMessage());
            return false;
        }
    }
    ...
    public Optional<User> findByNicknameAndPassword(String nickname, String password) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                ...
                logger.warn("Failed to find user by nickname {} and pwd {}", nickname, password);
                return Optional.empty();
            }
        } catch (SQLException e) {
            logger.error("Failed to find user by nickname {} and pwd {}. {}",
                    nickname, password, e.getMessage());
            return Optional.empty();
        }
    }
    ...
    public Optional<Roles> getRoleByNickname(String nickname) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                ...
                logger.warn("Failed to find role by nickname {}", nickname);
                return Optional.empty();
            }
        } catch (SQLException e) {
            logger.error("Failed to find role by nickname {}: {}", nickname, e.getMessage());
            return Optional.empty();
        }
    }
    ...
    public int updateRole(String nickname, Roles role) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            logger.error("Failed to update role {}. {}", nickname, e.getMessage());
            return 0;
        }
    }
    ...
    public int delete(String nickname) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            logger.error("Failed to delete user {}. {}", nickname, e.getMessage());
            return 0;
        }
    }
